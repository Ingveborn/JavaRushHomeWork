...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        ArrayList<String> listTribleDouble = new ArrayList<String>();
        for (int i = 0; i < list.size(); i++)
        {
            String s = list.get(i);
            if (s.length() %  2 == 0)
            {
                listTribleDouble.add(s);
                listTribleDouble.add(s);
            }
            else
            {
        ...
        for (int i = 0; i < listTribleDouble.size(); i++)
        {
            System.out.println(listTribleDouble.get(i));
        }
    }
}
